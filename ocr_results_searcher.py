...
This script analyzes OCR output JSON files generated by the main.py script and searches
for user-specified words in each page. Pages that contain at least one of the search words
are marked as True, otherwise False.

Usage:
    python search_pdf_content.py --json-path path/to/ocr_results.json --words word1 word2 word3
"""
